<%@ Page Title="" Language="C#" MasterPageFile="MainMasterPage.master" AutoEventWireup="true" CodeFile="User.aspx.cs" Inherits="AdminDetail" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <!-- START CONTENT -->
    <div class="card-panel">
        <h4 class="header1">Registered Users</h4>
                ...
                <div class="row">
                    ...
                    <div class="col s12">
                        <table id="data-table-simple" class="responsive-table hover" cellspacing="0">
                            ...
                            <tbody>
                                <asp:Repeater ID="user_grid" runat="server" OnItemCommand="user_grid_ItemCommand">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                            ...
                                            <td class="icon-preview center">
                                                ...
                                                <asp:LinkButton ID="lbdelete" runat="server" CommandName="delete" CommandArgument='<%# Eval("UserId") %>'><i class="material-icons" style="color:red">delete_forever</i></asp:LinkButton>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
